...
# (str) Package name
package.name = capsule50

# (str) Package domain (needed for android/ios packaging)
package.domain = org.cs50
...
android.permissions = android.permission.MANAGE_EXTERNAL_STORAGE, android.permission.READ_EXTERNAL_STORAGE, android.permission.WRITE_EXTERNAL_STORAGE
